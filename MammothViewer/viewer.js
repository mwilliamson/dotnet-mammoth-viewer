(function() {
    MammothViewer = {
        openFile: MammothViewerBackend.openFile.bind(MammothViewerBackend),
    ...
    function main() {
        var fileChoosers = initialiseFileChoosers();
        fileChoosers.forEach(function(fileChooser) {
            fileChooser.addEventListener("change", function() {
                var watchedFiles = fileChoosers.map(function(chooser) {
                    return chooser.value;
                });
                MammothViewer.setWatchedFiles(watchedFiles);
                renderOutput();
            }, false);
        });
    }
